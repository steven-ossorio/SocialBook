        ...
        <div className="form-background">
          ...
          <main className="signup-form-layout">
            ...
            <form className="signup-form">
              ...
              <br />
              <div className="terms-to-agree hidden-element">
                <p className="hidden-element">By clicking Create Account, you agree to our Terms and that you have read our Data Policy, including our Cookie Use.
