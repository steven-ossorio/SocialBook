...
class SignUpForm extends Component {
  ...
  errorsFirstName = propName => {
    ...
    if (errors[propName]) {
      return (
        <div className="signup-form-first-name-error">
          {" "}
          First name {errors[propName]}
        </div>
      );
    }
  };
  ...
  errorsLastName = propName => {
    ...
    if (errors[propName]) {
      return (
        <div className="signup-form-last-name-error">
          {" "}
          Last name {errors[propName]}
        </div>
      );
    }
  };
  ...
  errorsEmail = propName => {
    ...
    if (errors[propName]) {
      return (
        <div className="signup-form-email-error">Email {errors[propName]}</div>
      );
    }
  };
  ...
  errorsPassword = propName => {
    ...
    if (errors[propName]) {
      return (
        <div className="signup-form-password-error">
          Password {errors[propName]}
        </div>
      );
    }
  };
  ...
  errorsSex = propName => {
    ...
    if (errors[propName]) {
      return (
        <div className="signup-form-sex-error">
          Selection {errors[propName]}
        </div>
      );
    }
  };
          ...
          <main className="signup-form-layout">
            ...
            <form className="signup-form">
              ...
              <div className="signup-birthday-section">
                <select
                  className="signup-birthday-month"
                ...
                <select
                  className="signup-birthday-date"
                ...
                <select
                  className="signup-birthday-year"
                  value={this.state.year}
                  onChange={this.update("year")}
                >
                  {years}
                </select>
                <p className="birthday-requiremenr">
              ...
              <br />
              <button className="signup-button" onClick={this.submit}>
                Create Account
              </button>
              <hr />
            </form>
